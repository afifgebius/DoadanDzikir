package com.example.doadandzikir.data
...
object DataDzikirDoa {
    ...
    val listDzikirPagi: ArrayList<DzikirDoa>
        get() {
            val list1 = arrayListOf<DzikirDoa>()
    ...
    val listDzikirPetang: ArrayList<DzikirDoa>
        get() {
            val lists = arrayListOf<DzikirDoa>()
    ...
    val listDzikir: ArrayList<DzikirDoa>
        get() {
            val list2 = arrayListOf<DzikirDoa>()
