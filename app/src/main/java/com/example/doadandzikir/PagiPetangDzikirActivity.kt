...
class PagiPetangDzikirActivity : AppCompatActivity(), View.OnClickListener {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnDzikirPagi: ImageButton = findViewById(R.id.btn_pagi)
        ...
        val btnDzikirPetang: ImageButton = findViewById(R.id.btn_petang)
    ...
    override fun onClick(v: View?) {
        when (v?.id) {
            ...
            R.id.btn_pagi -> startActivity(Intent(this,DzikirPagiActivity::class.java))

            R.id.cv_dzikir_petang -> startActivity(Intent(this,DzikirPetangActivity::class.java))
            R.id.btn_petang -> startActivity(Intent(this,DzikirPetangActivity::class.java))
        }
    }
